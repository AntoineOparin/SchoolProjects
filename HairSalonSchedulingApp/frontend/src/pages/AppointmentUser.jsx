  ...
  return (
    <div className="min-h-screen">
      <div className="flex bg-sky-800 p-1 min-h-screen">
        {/* left side */}
        <div className="w-1/4 bg-sky-200 rounded-lg m-1 p-2">
          <div className="text-xl font-bold text-sky-950 mb-4">
            My Appointments
          </div>
          <Logo
          ...
          <div className="mt-8 space-y-4">
            <div>
              <label className="block text-sky-950 mb-2">Filter by Status</label>
              <select
                value={statusFilter}
